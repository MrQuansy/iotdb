...
public class BooleanTVList extends TVList {
  ...
  public TVList splitByFlushingWindow(double flushingWindowProportion) {
    BooleanTVList flushTVList = new BooleanTVList();
    ...
    boolean[] valueFlushArray = (boolean[]) getPrimitiveArraysByType(TSDataType.BOOLEAN);
    ...
    List<boolean[]> valueWindow = values;
    ...
    boolean[] remainValue = new boolean[newRowCount];
    int existCount = 0;
    ...
    rowCount = 0;
    putBooleans(remainTime, remainValue, null, 0, newRowCount);
