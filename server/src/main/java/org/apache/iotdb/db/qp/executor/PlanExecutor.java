...
public class PlanExecutor implements IPlanExecutor {
  ...
  public boolean processNonQuery(PhysicalPlan plan)
    ...
    switch (plan.getOperatorType()) {
      ...
      case CREATE_MIXED_TIMESERIES:
        return createMixedTimeSeries((CreateMixedTimeSeriesPlan) plan);
  ...
  private boolean createMixedTimeSeries(CreateMixedTimeSeriesPlan createMixedTimeSeriesPlan)
      throws QueryProcessException {
    try {
      IoTDB.metaManager.createMixedTimeSeries(createMixedTimeSeriesPlan);
    } catch (MetadataException e) {
      throw new QueryProcessException(e);
    }
    return true;
