...
public class LongTVList extends TVList {
  ...
  public TVList splitByFlushingWindow(double flushingWindowProportion) {
    LongTVList flushTVList = new LongTVList();
    ...
    long[] valueFlushArray = (long[]) getPrimitiveArraysByType(TSDataType.INT64);
    ...
    long[] remainValue = new long[newRowCount];
    int existCount = 0;
    ...
    rowCount = 0;
    putLongs(remainTime, remainValue, null, 0, newRowCount);
