...
public class CreateMixedGroupTimeSeriesPlan extends PhysicalPlan {
  ...
  public List<PartialPath> getPaths() {
    ...
    for (String measurement : measurements) {
      try {
        ...
        logger.error("Failed to get paths of CreateMixedGroupTimeSeriesPlan. ", e);
      }
    }
    return paths;
  }
  ...
  public void serialize(DataOutputStream stream) throws IOException {
    stream.writeByte((byte) PhysicalPlanType.CREATE_MIXED_GROUP_TIMESERIES.ordinal());
  ...
  public void serializeImpl(ByteBuffer buffer) {
    buffer.put((byte) PhysicalPlanType.CREATE_MIXED_GROUP_TIMESERIES.ordinal());
    byte[] bytes = prefixPath.getFullPath().getBytes();
